classdef QueryOutcome < aws.Object
% QUERYOUTCOME Constructs a new QueryOutcome object
% A QueryOutcome is constructed based on the equivalent underlying Java SDK
% object.
...
methods
    function obj = QueryOutcome(varargin)

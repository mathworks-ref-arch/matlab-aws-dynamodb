function updateItemSpec = withPrimaryKey(obj, varargin)
...
%
% Example:
%   updateItemSpec = updateItemSpec.withPrimaryKey(myPrimaryKey);
%   or
%   updateItemSpec = updateItemSpec.withPrimaryKey('myKeyName', 1977);
...
if nargin == 2
    ...
    updateItemSpecJ = obj.Handle.withPrimaryKey(primaryKey.Handle);
else
    hashKeyName = p.Results.hashKeyName;
    hashKeyValue = p.Results.hashKeyValue;
    updateItemSpecJ = obj.Handle.withPrimaryKey(hashKeyName, hashKeyValue);
end

function getItemSpec = withPrimaryKey(obj, varargin)
% WITHPRIMARYKEY Sets item PrimaryKey
...
%
% Example:
%   getItemSpecResult = getItemSpec.withPrimaryKey(myPrimaryKey);
%   or
%   getItemSpecResult = getItemSpec.withPrimaryKey('myKeyName', 1977);
...
if nargin == 2
    ...
    getItemSpecJ = obj.Handle.withPrimaryKey(primaryKey.Handle);
else
    hashKeyName = p.Results.hashKeyName;
    hashKeyValue = p.Results.hashKeyValue;
    getItemSpecJ = obj.Handle.withPrimaryKey(hashKeyName, hashKeyValue);
end
